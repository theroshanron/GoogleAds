...
- Click on the advertiser and then click on the campaign
- Always create multiple and minimum 4 line items
- Click on the new Line item (Contextual)
  - Select the insertion order and one type of the line item
  - Let's say you click on the display
  - Name of the Line item and status
  - All the properties will be inherited from the insertion order
  - Select the relevant category
  - Add flight Dates
  - Select the budget and adjustments and try to make people believe that you exist
  - Add frequency cap
  - Assign creatives for the line item
  - Add Floodlight pixel for conversion tracking
    - Select count all conversions
  - Select the attribution model to use for conversion measurements
- Click on the new Line item (Audience list)
  - Google Audience or third party audience
    - Third party audience  
      - Select the segments of audience you want to target 
    - Google Audience 
      - In-Market audience 
        - Select the relevant audiences
  - Look in the right bar side details about the audience you selected like demographics, device or age range
- Click on the new Line item (Custom Audience) 
  - Go to the audience list and select custom audience
  - Name the audience
  - Description
  - Add keywords related to the product and services
  - Copy and competitor's website url to target audience who are looking for similar products
  - Other properties remains same as Insertion order 
- Click on the new Line item (Retargeting Audience)
  - Add targeting and then audience list 
  - Select first and third party 
  - Go to the first party settings 
  - Select the pixel and apply
  - Select the same creatives as previous line items 
  - Other properties remains same as insertion order

## Reporting - Create, share and schedule
- Click on **insights** at left hand side
- Types of reports in DV360 
  - Offline: 
    - Supports all metric and dimensions
    - Download, send or schedule in Excel, PDF or other formats
  - Instant:
    - Does not support all metrics and dimensions
    - Report supports a graph, pie chart, etc and is viewed within UI
  - Dashboards:
    - Multiple instant report widgets (Multiple instant reports)
    - Can't send or schedule
- Click on insights and then Reports
  - View existing reports or click on offline reporting
    - Click on New offline reporting
      - Name of the report
      - Date range
      - Language formatting
      - You can select the report template for certain specific type reporting like billing
      - Select the metrics under report Setup for custom reporting
      - Schedule the report and date range becomes the dynamic like last 7 days or today
      - Select the format for the report
      - File_name of the report 
      - Add email address to which reports need to be the sent
  
### Instant Reporting
- Click on New instant report
- Name the report
- Drag drop the custom data (Dimension and metric) from right hand side to rows and columns

### Dashboards
- Click on New dashboard
- Name the dashboard and add description
- Add different widgets like Note, table or chart
- Create new table (Instant report or existing one to the dashboard)
