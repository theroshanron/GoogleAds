...
## Create Audience segment and Remarketing ads
- User who already visited the site are aware of the products and likely to become a conversion
- We can create a floodlight activity or membership by custom floodlight variables for remarketing
  - Create a floodlight activity events
  - Create an Audience
  - Target this audience in an Ads
- Go to the advertiser account and click on Floodlight
  - Click on Activity and click on New
  - Add Floodlight activity name 
  - Expected URL and type (Counter or Sales)
  - Select the activity group
  - Select the counting method (unique for visitor)
  - Tag format: Global site
  - Leave everything as default and then click on save.
  - Select the floodlight activity and then export it in tee text format.
  - Add the global snippet in the header.
- Go to the audience and add the name.
  - Add the membership lifespan based on user who visited the website recently.
  - Add the audience type:
    - All visitors who trigger a floodlight activity
    - Create a custom rule.
  - Select the floodlight activity
  - Select the account which can target and share these audience
  - We can also allow advertisers to target this list.
  - Click on Save.
  - We cannot target this audience to a default ad.
  - Create a new standard Ad and select targeting to select the audience list.